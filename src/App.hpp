...
namespace dyadikos {
    ...
    class Application {
        private:
            ...
            void recreateSwapChain(const std::vector<Vertex> vertices) {
            ...
            void setupDebugCallback() {
                ...
                // NOTE: Vulkan-hpp has methods for this, but they trigger
                // linking errors...
                // instance->createDebugUtilsMessengerEXT(createInfo);
                // instance->createDebugUtilsMessengerEXTUnique(createInfo);

                // NOTE: reinterpret_cast is also used by vulkan.hpp internally
                // for all these structs
            ...
            void createCommandBuffers(const std::vector<Vertex> &vertices) {
                ...
                for (size_t i = 0; i < commandBuffers.size(); i++) {
                    ...
                    commandBuffers[i].bindVertexBuffers(0, 1, vertexBuffers,
                                                        offsets);
        ...
        public:
            auto getWindowSize() -> glm::vec2 { return windowSize; }
